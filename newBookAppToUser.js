                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                               <tbody>
                                                                  <tr>
                                                                        ...
                                                                        <p style="margin: 20px 20px 20px 20px;font-size: 25px;text-align: left;"> <b>${newBookAppToUser.men1}</b>  </p>
                                                                        <p style="margin: 20px 20px 20px 20px;font-size: 25px;text-align: left;"> <b>${newBookAppToUser.numeroCuenta}</b>  </p>
                                                                        <p style="margin: 20px 20px 20px 20px;font-size: 25px;text-align: left;"> <b>${newBookAppToUser.rut}</b>  </p>
                                                                        <p style="margin: 20px 20px 20px 20px;font-size: 25px;text-align: left;"> <b>${newBookAppToUser.titular}</b>  </p>
                                                                        <p style="margin: 20px 20px 20px 20px;font-size: 25px;text-align: left;"> <b>${newBookAppToUser.emailContacto}</b>  </p>
                                                                        <p style="margin: 20px 20px 20px 20px;font-size: 25px;text-align: left;"> <b>${newBookAppToUser.telefonoContacto}</b>  </p>
