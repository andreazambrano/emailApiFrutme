                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                               <tbody>
                                                                  <tr>
                                                                    ...
                                                                    <img src="https://www.andesproadventures.com/assets/media/book/successValidation.png" border="0" alt="" / >
                                                                        </td>
                                                                     </td>
                                                      ...
                                                      <tr>
                                                         <td align="center" style="padding:20px 20px 10px 20px">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                               <tbody>
                                                                  <tr>
                                                                        <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 25px; line-height: 24px; text-align: left;" class="title-color">Hola ${newValidationAppToUser.nombre}, su solicitud de reserva Nro. ${newValidationAppToUser.nroReserva} fue confirmada con exito. </h3>
